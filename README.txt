...
3) By entering 'SpectraCleaner' in the command prompt, the app should run. The
executable file appears in the folder ~/.local/bin. If you hav eproblems, you 
can go there (cd ~/.local/bin) and then execute the file (./SpectraCleaner).
